	...
	$('#settings-modal-btn').click(() => {
		openModal(
			...
			<div class="custom-control custom-checkbox">
				<input ${
					settings.num_abrev ? 'checked' : ''
				} type="checkbox" class="custom-control-input" id="setting-num-abrev-checkbox">
				<label class="custom-control-label" for="setting-num-abrev-checkbox">Display large numbers with abbreviations</label>
			</div>
			<div class="custom-control custom-checkbox">
				<input ${
					settings.show_aquarium ? 'checked' : ''
				} type="checkbox" class="custom-control-input" id="setting-show-aquarium-checkbox">
			...
			${
				unlocks['bank']
					? `<div class="custom-control custom-checkbox">
				<input ${
					settings.bank_input_limit ? 'checked' : ''
				} type="checkbox" class="custom-control-input" id="setting-bank-input-limit-checkbox">
		...
		$('#setting-background-volume-input').change(() => {
			setVolume(
				'background',
				$('#setting-background-volume-input').val()
			);
			...
			`<div id="help-carousel" class="carousel slide" data-ride="carousel" data-interval="false">
				<div class="carousel-inner">
					<div class="carousel-item active">
						...
						${
							unlocks['medium-fish']
								? `<p>Medium fish <i class="fas fa-fish"></i> eat small fish, and earn more coins than small fish</p>`
								: ''
						}
						${
							unlocks['big-fish']
								? `<p>Big fish <i class="fas fa-fish"></i> eat medium fish, and earn more coins than medium fish</p>`
								: ''
						}
						${
							unlocks['sell-small-fish'] ||
							unlocks['sell-medium-fish'] ||
							unlocks['sell-big-fish']
								? `<p>You can sell <i class="fas fa-donate"></i> fish for half price</p>`
								: ''
						}
						${
							unlocks['aquarium']
								? `<p>Fish take up space in your aquarium <i class="fas fa-water"></i>. If you run out of space, you'll have to sell fish or purchase another aquarium.</p>`
								: ''
						}
					...
					${
						...
						${
							unlocks['food-farm']
								? `<p><i class="fas fa-farm"></i> Food farms produce food for your small fish every second</p>`
								: ''
						}
						${
							unlocks['small-hatchery']
								? `<p><i class="fas fa-building"></i> Small fish hatcheries produce small fish every second</p>`
								: ''
						}
						${
							unlocks['medium-hatchery']
								? `<p><i class="fas fa-building"></i> Medium fish hatcheries produce small fish every second</p>`
								: ''
						}
						${
							unlocks['big-hatchery']
								? `<p><i class="fas fa-building"></i> Big fish hatcheries produce small fish every second</p>`
								: ''
						}
						${
							unlocks['small-hatchery'] ||
							unlocks['medium-hatchery'] ||
							unlocks['big-hatchery']
								? `<p>Hatcheries produce in the order: small, medium, big</p>`
								: ''
						}
						${
							unlocks['aquarium']
								? `<p><i class="fas fa-water"></i> Aquariums allow you to hold more fish</p>`
								: ''
						}
						${
							unlocks['aquarium-factory']
								? `<p><i class="fas fa-industry-alt"></i> Aquarium factories produce aquariums every second</p>`
								: ''
						}
						${
							unlocks['bank']
								? `<p><i class="fas fa-landmark"></i> Banks enable you to buy and sell buildings every second, automatically</p>`
								: ''
						}
						${
							unlocks['bank']
								? `<p><i class="fas fa-landmark"></i> You can drag <i class="fas fa-arrows-alt"></i> your order items to change the priority of bank transactions</p>`
								: ''
						}
						${
							unlocks['bank-fish']
								? `<p><i class="fas fa-landmark"></i> You can also buy and sell fish at banks</p>`
								: ''
						}
						${
							unlocks['big-banking']
								? `<p><i class="fas fa-landmark"></i> You can even buy banks with banks!</p>`
								: ''
						}
						<br>
					</div>`
					...
					${
						...
						${
							unlocks['volume']
								? `<p>Turn on the volume with the <i class="fas fa-volume-up"></i> button above</p>`
								: ''
						}
						${
							unlocks['fullscreen']
								? `<p>Go into fullscreen mode with the <i class="fas fa-arrows-alt"></i> button above</p>`
								: ''
						}
						${
							unlocks['fullscreen-aquarium']
								? `<p>Enter fullscreen aquarium mode with the <b><i class="fas fa-external-link-alt"></i> Fullscreen Aquarium</b> button below. Your game will run in the background, but you'll get to watch your beautiful fish swim around. It's a great wallpaper.</p>`
								: ''
						}
						${
							unlocks['stats']
								? `<p>Check out your game stats with the <b><i class="fas fa-sort-amount-up"></i> Stats</b> button below</p>`
								: ''
						}
					...
					${
						...
						${
							unlocks.buildings
								? `<p><i>I have a building that should be producing but the numbers aren't going up. Why?</i></p>`
								: ''
						}
